...
from rag_knowledgebase.rag_pipeline import ingest_graph_documents


def main() -> None:
    settings = get_settings()
    count = ingest_graph_documents(settings)
    print(f"[ok] Graph store ingest completed. Documents: {count}")
